...
game.States.preload = function(){
	this.preload = function(){
		...
		//以下为要加载的资源
		game.load.image('background','/i/flappybirdmobile/background.png'); //背景
    	game.load.image('ground','/i/flappybirdmobile/ground.png'); //地面
    	game.load.image('title','/i/flappybirdmobile/title.png'); //游戏标题
    	game.load.spritesheet('bird','/i/flappybirdmobile/bird.png',34,24,3); //鸟
    	game.load.image('btn','/i/flappybirdmobile/start-button.png');  //按钮
    	game.load.spritesheet('pipe','/i/flappybirdmobile/pipes.png',54,320,2); //管道
    	game.load.bitmapFont('flappy_font', '/i/flappybirdmobile/flappyfont.png', '/fonts/flappybirdmobile.fnt');
    	game.load.audio('fly_sound', '/audio/flappybirdmobile/flap.wav');//飞翔的音效
    	game.load.audio('score_sound', '/audio/flappybirdmobile/score.wav');//得分的音效
    	game.load.audio('hit_pipe_sound', '/audio/flappybirdmobile/pipe-hit.wav'); //撞击管道的音效
    	game.load.audio('hit_ground_sound', '/audio/flappybirdmobile/ouch.wav'); //撞击地面的音效

    	game.load.image('ready_text','/i/flappybirdmobile/get-ready.png');
    	game.load.image('play_tip','/i/flappybirdmobile/instructions.png');
    	game.load.image('game_over','/i/flappybirdmobile/gameover.png');
    	game.load.image('score_board','/i/flappybirdmobile/scoreboard.png');
	}
	this.create = function(){
