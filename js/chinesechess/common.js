...
window.onload = function(){  
	...
	com.getData("/js/chinesechess/gambit.all.js",
		function(data){
		com.gambit=data.split(" ");
		AI.historyBill = com.gambit;
	})
	com.getData("/js/chinesechess/store.js",
		function(data){
...
com.loadImages = function(stype){
	...
	//绘制棋盘
	com.bgImg = new Image();
	com.bgImg.src  = "/i/chinesechess/"+stype+"/bg.png";
	
	//提示点
	com.dotImg = new Image();
	com.dotImg.src  = "/i/chinesechess/"+stype+"/dot.png";
	
	//棋子
	for (var i in com.args){
		com[i] = {};
		com[i].img = new Image();
		com[i].img.src = "/i/chinesechess/"+stype+"/"+ com.args[i].img +".png";
	}
	
	//棋子外框
	com.paneImg = new Image();
	com.paneImg.src  = "/i/chinesechess/"+stype+"/r_box.png";
	
	document.getElementsByTagName("body")[0].style.background= "url(/i/chinesechess/"+stype+"/bg.jpg)";
