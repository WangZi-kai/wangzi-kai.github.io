...
function initCopyBtns() {
    var b = 'url(\'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="currentColor" d="M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z"/></svg>\')';
    var a = 'url(\'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="%231A7F37" d="M20.285 6.708l-11.024 11.025-5.285-5.285 1.414-1.414 3.871 3.871 9.611-9.611z"/></svg>\')';
    var f = 'url(\'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><circle cx="12" cy="12" r="10" fill="%23e74c3c"/><rect x="11" y="6" width="2" height="8" fill="white"/><rect x="11" y="16" width="2" height="2" fill="white"/></svg>\')';
    var d = document.createElement("style");
    d.type = "text/css";
    d.appendChild(document.createTextNode(".copy_btn {box-shadow: none;vertical-align: middle;cursor: pointer;width: 16px;height: 16px;border: none;background: none;background-image: " + b + ";background-repeat: no-repeat;background-size: 100%;opacity: 0.7;transition: opacity 0.2s;}.copy_btn:hover {opacity: 1;}"));
    document.head.appendChild(d);
    function c(g, h, i) {
        if (typeof i === "undefined") {
            i = 1000
        }
        g.style.backgroundImage = h;
        if (g._timer) {
            clearTimeout(g._timer)
        }
        g._timer = setTimeout(function() {
            g.style.backgroundImage = b
        }, i)
    }
    var e = new ClipboardJS(".copy_btn");
    e.on("success", function(g) {
        c(g.trigger, a)
    });
