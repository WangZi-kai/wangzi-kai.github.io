 ...
 */
	...
	b56o: function(t, e, i) {
		...
		n = n.map(function(t) {
			return "//f.bmcx.com/file/gangqin/images/" + t
		}),
		e.a = n
	},
	bIJo: function(t, e, i) {
		...
		o = [function() {
			...
			[t._v("在线钢琴")]), t._v(" © 2004~"+new Date().getFullYear())])]), t._v("\n     | \n    "), i("li", {
				staticClass: "footer-item"
			},
			[i("a", {
				attrs: {
	...
	uTwv: function(t, e, i) {
		t.exports = i.p + "/f.bmcx.com/file/gangqin/img/wxqr.543cb70.png"
	},
	uqUo: function(t, e, i) {
		var n = i("kM2E"),
		o = i("FeBl"),
